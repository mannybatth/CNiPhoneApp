...
CGFloat kCalculatedContentPadding = 10;
CGFloat kMinimumScrollOffsetPadding = 20;
...
- (void)setCalculatedContentPadding:(CGFloat)padding {
    kCalculatedContentPadding = padding;
}

- (void)setMinimumScrollOffsetPadding:(CGFloat)padding {
    kMinimumScrollOffsetPadding = padding;
}
...
{
    [self TPKeyboardAvoiding_scrollToActiveTextField:0.25];
}

-(void)TPKeyboardAvoiding_scrollToActiveTextField:(CGFloat)duration {
    TPKeyboardAvoidingState *state = self.keyboardAvoidingState;
