...
- (void)drawRect:(CGRect)rect {
    ...
    self.selectionIndicatorBoxLayer.backgroundColor = self.selectionBoxBackgroundColor.CGColor;
    self.selectionIndicatorBoxLayer.borderColor = self.selectionBoxBackgroundColor.CGColor;
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    if (CGRectContainsPoint(self.bounds, touchLocation)) {
        ...
        if (self.segmentWidthStyle == HMSegmentedControlSegmentWidthStyleFixed) {
            ...
            if (segment >= self.segmentWidthsArray.count) return;
        }
