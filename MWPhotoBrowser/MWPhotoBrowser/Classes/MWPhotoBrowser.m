...
- (void)doneButtonPressed:(id)sender {
    ...
    if (_doneButton) {
        if ([_delegate respondsToSelector:@selector(photoBrowserDidFinishModalPresentation:canceled:)]) {
            // Call delegate method and let them dismiss us
            [_delegate photoBrowserDidFinishModalPresentation:self canceled:NO];
        } else  {
...
- (void)cancelButtonPressed:(id)sender {
    if (_cancelButton) {if ([_delegate respondsToSelector:@selector(photoBrowserDidFinishModalPresentation:canceled:)]) {
        // Call delegate method and let them dismiss us
        [_delegate photoBrowserDidFinishModalPresentation:self canceled:YES];
    } else  {
        [self dismissViewControllerAnimated:YES completion:nil];
    }
    }
